...
// Receives localized auth strings from the server component.
// ─────────────────────────────────────────────────────────────────────────────
...
export function LoginClient({ auth }: { auth: AuthStrings }) {
  return (
    <main className="flex-1 flex flex-col items-center justify-center hero-gradient">
      <div className="w-full max-w-sm mx-auto px-6">
        ...
        {/* Card */}
        <div className="bg-card rounded-2xl p-8 card-shadow-lg border border-border/30">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-border rounded-xl font-medium text-sm text-foreground hover:bg-gray-50 transition-colors cursor-pointer"
            >
          ...
          <p className="mt-6 text-xs text-center text-muted/70">
